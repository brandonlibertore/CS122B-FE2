...
export async function login(loginRequest) {
    ...
    const options = {
        ...
        baseURL: Config.userBaseUrl, // Base URL (localhost:8081 for example)
...
export async function myRequest(accessToken, queryParams) {

    const options = {
        method: "GET", // Method type
        baseURL: Config.movieBaseUrl, // Base part of URL
        url: Config.movies.search, // Path part of URL,
        params: queryParams,
        headers:{
